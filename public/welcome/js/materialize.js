    ...
    a.fn.extend({
      openModal: function (c) {
        ...
        h.hasClass("open") ||
          ...
          (lStack = ++b),
          $overlay.attr("id", overlayID).css("z-index", 1e3 + 2 * lStack),
          h.data("overlay-id", overlayID).css("z-index", 1e3 + 2 * lStack + 1),
          h.addClass("open"),
          a("body").append($overlay),
          (c = a.extend(g, c)),
          c.dismissible &&
          ...
          h.data("associated-overlay", $overlay[0]),
    ...
    var b = {
      init: function () {
        return this.each(function () {
          ...
          b.is(":visible") &&
            (i.css({ right: f - (h + 1) * g }), i.css({ left: h * g })),
            a(window).resize(function () {
              (f = b.width()),
                (g = Math.max(f, b[0].scrollWidth) / e.length),
                0 > h && (h = 0),
                ...
                (e = void 0 === e || "" === e ? c.delay : e),
                  (j = setTimeout(function () {
                    (k = !0),
                      h.velocity("stop"),
                      i.velocity("stop"),
                      h.css({ display: "block", left: "0px", top: "0px" }),
                    ...
                    "top" === l
                      ...
                      : ((a = f.offset().top + f.outerHeight() + d),
                        ...
                        (e = b(c, a, n, m)),
                        (o = "+10px"),
                        i.css({ marginLeft: n / 2 - i.width() / 2 })),
                      h.css({ top: e.y, left: e.x }),
                      (q = n / 8),
                      8 > q && (q = 8),
                      ("right" === l || "left" === l) &&
                        ((q = n / 10), 6 > q && (q = 6)),
          ...
          this.each(function () {
            function c() {
              "undefined" != typeof window.ontouchstart &&
                (F[0].addEventListener("touchstart", k),
              ...
              for (
                o = "number" == typeof a ? a : o,
                  ...
                  b.full_width
                    ...
                    : ((j =
                        "translateX(" +
                        (F[0].clientWidth - item_width) / 2 +
                        "px) "),
                      (j +=
                        "translateY(" +
                        (F[0].clientHeight - item_width) / 2 +
                        "px)")),
                  i = n[f(p)],
                  i.style[z] =
                    j +
            ...
            function i() {
              ...
              v &&
                ...
                c > 2 || -2 > c ? (g(w - c), requestAnimationFrame(i)) : g(w));
            }
            function j(c) {
              ...
              if (!b.full_width) {
                var d = a(c.target).closest(".carousel-item").index(),
                  e = (p % s) - d;
                0 > e
                  ? Math.abs(e + s) < Math.abs(e) && (e += s)
                  : e > 0 && Math.abs(e - s) < e && (e -= s),
                  0 > e
                    ? a(this).trigger("carouselNext", [Math.abs(e)])
                    : e > 0 && a(this).trigger("carouselPrev", [e]);
              }
            }
            function k(a) {
              (q = !0),
            ...
            var n,
              ...
              E,
              F = a(this);
            return F.hasClass("initialized")
              ? !0
              : (b.full_width &&
                  ((b.dist = 0),
                  (imageHeight = F.find(".carousel-item img")
                    .first()
                    .load(function () {
                ...
                a(this).on("carouselNext", function (a, b) {
                  void 0 === b && (b = 1),
                    (w = o + r * b),
                    o !== w &&
                      ((v = w - o), (B = Date.now()), requestAnimationFrame(i));
                }),
